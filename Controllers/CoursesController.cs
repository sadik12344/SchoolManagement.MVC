...
namespace SchoolManagement.MVC.Controllers
{
    ...
    {
        private readonly SchooManagementDbContext _context;

        public CoursesController(SchooManagementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Courses!=null?
                 ...
                 Problem("Entity set 'SchoolManagementDbContent.Courses' is null");
        }
